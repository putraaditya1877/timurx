             ...
             <div class="card-body custom-border-top box-card">
                 ...
                 <form action="home/edit" method="post" enctype="multipart/form-data">
                     <div class="form-group row col-sm-12">
                         ...
                         <div class="col-sm-9">
                             <input type="text" class="form-control" id="judulwebsite" name="judulwebsite" value="<?= $judulwebsite ?>" placeholder="Ketik Disini" required />
                         </div>
                         <div class="form-group row col-sm-12">
                             <div class="col-sm-6">
                             ...
                             <div class="col-sm-6 mt-3">
                                 <img id="logoPrev" class="mr-auto ml-auto" width='100' src="<?= BASEURL ?>assets/upload/<?= $logoperusahaan; ?>" alt="image preview" />
                         ...
                         <div class="form-group row col-sm-12">
                             ...
                             <div class="col-sm-6 mt-3">
                                 <img id="iconPrev" class="mr-auto ml-auto" width='100' src=" <?= BASEURL ?>assets/upload/<?= $iconperusahaan; ?>" alt="image preview" />
