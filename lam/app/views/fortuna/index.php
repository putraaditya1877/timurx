...
<head>
    ...
    <title>Lembaga Adat Melayu</title>
...
<body class="landing-page sidebar-collapse">
  ...
  ?>
        ...
        <section class="section-padding" id="customer">
            ...
            ?>
                    ...
                    <div class="text-center ml-3 pt-1 pb-1">
                        <h4>Sudah banyak yang telah mempercayakan produknya di PT Timur Kasih Karunia. Apakah anda
                            selanjutnya?</h4>
                    </div>
                </div>
                <!-- carousel -->
    ...
    <section class="section-padding" id="client">
        <div class="container-fluid section-padding bg-grey pb-2">
            <div class="section mb-0">
                <h2 class="text-center ml-auto mr-auto" style="max-width: 600px;">Nge-deal sama ideal steel,
                    #SemuaBisaCuan</h2>
            </div>
            <div class="col-md-6 col-12 ml-auto mr-auto">
                <div class="row">
                    <div class="col-md-4 col-10 ml-auto mr-auto">
                        <img src="<?= BASEURL ?>assets/assetskk/img/07.png"
                            class="client-item img-raised rounded img-fluid" alt="">
                    </div>
                    <div class="col-md-4 col-10 ml-auto mr-auto">
                        <img src="<?= BASEURL ?>assets/assetskk/img/07.png"
                            class="client-item img-raised rounded img-fluid" alt="">
                ...
                <div class="text-center ml-3 pt-1 pb-1">
                    <h4>Lebih dari 20 merek mempercayakan produknya di PT Timur Kasih Karunia. Toko anda juga bisa punya
                        merek baja ringan sendiri!</h4>
                </div>
            </div>
            <!-- carousel -->
            <div class="col-md-8 col-10 ml-auto mr-auto pt-4 pb-5 client">
                <div class="slide-client owl-carousel owl-theme">
                    <div class="item">
                        <img src="<?= BASEURL ?>assets/assetskk/img/07.png" alt=""
                            class="client-img img-raised rounded img-fluid" srcset="">
                    </div>
                    <div class="item">
                        <img src="<?= BASEURL ?>assets/assetskk/img/07.png" alt=""
                            class="client-img img-raised rounded img-fluid" srcset="">
            ...
            ?>
                        ...
                        <div class="item">
                            ...
                            <img class="mr-auto ml-auto"
                                src="<?= BASEURL ?>assets/upload/outlet/<?= $hk['gambaroutlate'] ?>" alt="" srcset="" />
